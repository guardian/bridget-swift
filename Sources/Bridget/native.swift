...
public final class ReportAbuseParameters {
  ...
  public init(commentId: String, categoryId: String) {
    self.commentId = commentId
    self.categoryId = categoryId
  }

  public init(commentId: String, categoryId: String, reason: String?, email: String?) {
    self.commentId = commentId
    self.categoryId = categoryId
    self.reason = reason
    self.email = email
...
public final class AddUsernameError {
...
public final class AddUsernameApiResponse {

  public var status: String

  public var errors: TList<AddUsernameError>?
  ...
  public init(status: String, errors: TList<AddUsernameError>?) {
    self.status = status
    self.errors = errors
  }
...
public enum AddUsernameResponse {

  case response(val: AddUsernameApiResponse)
...
public protocol Discussion {
  ...
  /// - Returns: DiscussionResponse
  /// - Throws: 
  func preview(body: String) throws -> DiscussionResponse
  ...
  /// - Parameters:
  ///   - username: 
  /// - Returns: AddUsernameResponse
  /// - Throws: 
  func addUsername(username: String) throws -> AddUsernameResponse
  ...
  /// - Returns: DiscussionResponse
  /// - Throws: 
  func reportAbuse(parameters: ReportAbuseParameters) throws -> DiscussionResponse
...
public protocol DiscussionAsync {
  ...
  ///   - body: 
  ///   - completion: Result<DiscussionResponse, Error> wrapping return and following Exceptions: 
  func preview(body: String, completion: @escaping (Result<DiscussionResponse, Error>) -> Void)
  ...
  /// - Parameters:
  ///   - username: 
  ///   - completion: Result<AddUsernameResponse, Error> wrapping return and following Exceptions: 
  func addUsername(username: String, completion: @escaping (Result<AddUsernameResponse, Error>) -> Void)

  ///
  /// - Parameters:
  ///   - parameters: 
  ///   - completion: Result<DiscussionResponse, Error> wrapping return and following Exceptions: 
  func reportAbuse(parameters: ReportAbuseParameters, completion: @escaping (Result<DiscussionResponse, Error>) -> Void)
...
public let BRIDGET_VERSION : String = "v0.0.0-2024-04-10-snapshot-2"
