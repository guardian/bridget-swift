...
public protocol ListenToArticle {
  ...
  /// - Returns: Int32
  /// - Throws: 
  func getAudioDurationSeconds(articleId: String) throws -> Int32
...
public protocol ListenToArticleAsync {
  ...
  func getAudioDurationSeconds(articleId: String, completion: @escaping (Result<Int32, Error>) -> Void)
...
public let BRIDGET_VERSION : String = "v8.7.0"
